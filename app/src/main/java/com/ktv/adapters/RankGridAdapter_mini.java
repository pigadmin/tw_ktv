...
public class RankGridAdapter_mini extends RecyclerAdapter<GridItem> {

    private static final String TAG = "RankGridAdapter";

    public RankGridAdapter_mini(Context context, int layoutId, List datas) {
        super(context, layoutId, datas);
    }

    @Override
    public void convert(ViewHolders holder, GridItem item) {
        holder.itemView.setNextFocusUpId(R.id.rdb4_top_menu_dialog);
