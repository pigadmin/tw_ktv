...
public class CustomDialogAdater extends BaseAdapter {

    private LayoutInflater mInflater;
    private String[] articles;

    public CustomDialogAdater(Context context, String[] articles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.grid_item_x_dialog, parent, false);
