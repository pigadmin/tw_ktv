 ...
 * 歌曲Adater
 */
public class MusicSubFragmentDialogAdaters extends BaseAdapter {
    ...
    public MusicSubFragmentDialogAdaters(Context context, int layoutId, List<MusicPlayBean> list, DbManager mDb) {
