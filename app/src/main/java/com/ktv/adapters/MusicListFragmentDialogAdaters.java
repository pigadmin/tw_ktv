 ...
 * 歌曲Adater
 */
public class MusicListFragmentDialogAdaters extends BaseAdapter {

    private static final String TAG="MusicListFragmentDialogAdaters";
    ...
    public MusicListFragmentDialogAdaters(Context context, int layoutId, List<MusicPlayBean> list, DbManager mDb) {
