 ...
 * 歌曲Adater
 */
public class MusicListFragmentAdaters extends BaseAdapter {

    private static final String TAG = "MusicListFragmentAdaters";
    ...
    public MusicListFragmentAdaters(Context context, int layoutId, List<MusicPlayBean> list, DbManager mDb) {
