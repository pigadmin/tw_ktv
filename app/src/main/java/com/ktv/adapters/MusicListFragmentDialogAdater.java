 ...
 * 歌曲Adater
 */
public class MusicListFragmentDialogAdater extends BAdapter<MusicPlayBean> {

    private static final String TAG="MusicListFragmentDialogAdater";
    ...
    public MusicListFragmentDialogAdater(Context context, int layoutId, List<MusicPlayBean> list, DbManager mDb) {
