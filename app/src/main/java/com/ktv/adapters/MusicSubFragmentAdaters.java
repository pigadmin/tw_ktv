 ...
 * 歌曲Adater
 */
public class MusicSubFragmentAdaters extends BaseAdapter {

    private static final String TAG="MusicSubFragmentAdaters";
    ...
    public MusicSubFragmentAdaters(Context context, int layoutId, List<MusicPlayBean> list, DbManager mDb) {
